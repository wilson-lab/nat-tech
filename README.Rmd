...
You will also need to edit the first line at the top of `pipeline.R` and the top line of `functions.R` to source the `parameter.R` file that you edited above.
