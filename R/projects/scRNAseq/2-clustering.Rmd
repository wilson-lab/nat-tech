...
``` {r}
thresholds <- thresholds %>% tidyr::spread(Gene, thresh)
cellgroups <- list()
markers_values <- markers_avex %>% tidyr::spread(Gene, Avex)
cellgroups$neurons <- markers_values %>% dplyr::filter(nSyb>=thresholds$nSyb & elav>=thresholds$elav) %>% pull(Clusters)
...
save(Thirst2_celltypes, file = "/Users/abates/projects/wilson-lab/nat-tech/data/park_et_al_2022/GSE207799_Thirst2_celltypes.Robj")
```
