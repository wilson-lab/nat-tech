...
library(ggrepel)
library(bookdown)
setwd("/Users/abates/projects/wilson-lab/nat-tech/")
```

#### 2. Load data

``` {r}
load("data/park_et_al_2022/GSE207799_Thirst2_celltypes.Robj")
load("data/park_et_al_2022/GSE207799_Thirst2_SCT_trimPlus.Robj")
...
1 and adjusted p-value \< 0.05 are considered differently expressed.
